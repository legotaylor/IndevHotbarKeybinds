...
import net.minecraft.client.gui.GuiHotbarControls;
...
public final class GuiControls extends GuiScreen {
	...
	public final void initGui() {
		...
		this.controlList.add(new GuiButton(300, this.width / 2 - 100, this.height / 6 + 168 - 24, "Hotbar"));
	...
	protected final void actionPerformed(GuiButton guiButton1) {
		...
		} else if(guiButton1.id == 300) {
			this.mc.displayGuiScreen(new GuiHotbarControls(this, this.options));
		} else {
