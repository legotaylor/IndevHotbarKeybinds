...
public final class Minecraft implements Runnable {
					...
					while(Mouse.next()) {
						...
						if(this.currentScreen == null) {
							if(!this.inventoryScreen && Mouse.getEventButtonState()) {
								...
								this.checkHotbarBindings(Mouse.getEventButton(), false);
							}
					...
					while(true) {
						while(true) {
							...
							if(Keyboard.getEventKey() == Keyboard.KEY_F11) {
								...
								this.checkHotbarBindings(Keyboard.getEventKey(), true);
	...
	private void checkHotbarBindings(int code, boolean isKeyboard) {
		int eventKey = isKeyboard ? Keyboard.getEventKey() : Mouse.getEventButton();
		if (this.options.hotbar1.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar1.keyCode) this.thePlayer.inventory.currentItem = 0;
		} else if (this.options.hotbar2.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar2.keyCode) this.thePlayer.inventory.currentItem = 1;
		} if (this.options.hotbar3.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar3.keyCode) this.thePlayer.inventory.currentItem = 2;
		} if (this.options.hotbar4.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar4.keyCode) this.thePlayer.inventory.currentItem = 3;
		} if (this.options.hotbar5.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar5.keyCode) this.thePlayer.inventory.currentItem = 4;
		} if (this.options.hotbar6.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar6.keyCode) this.thePlayer.inventory.currentItem = 5;
		} if (this.options.hotbar7.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar7.keyCode) this.thePlayer.inventory.currentItem = 6;
		} if (this.options.hotbar8.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar8.keyCode) this.thePlayer.inventory.currentItem = 7;
		} if (this.options.hotbar9.hasCode(isKeyboard)) {
			if (eventKey == this.options.hotbar9.keyCode) this.thePlayer.inventory.currentItem = 8;
		}
	}
